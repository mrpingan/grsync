...
// rsync command
func (t Task) ShowCommand() string {
...
func NewTask(source, destination string, rsyncOptions RsyncOptions, is_su bool, su_user string) *Task {
	...
	return &Task{
		rsync: NewRsync(source, destination, rsyncOptions, is_su, su_user),
		state: &State{},
		log:   &Log{},
	}
}
